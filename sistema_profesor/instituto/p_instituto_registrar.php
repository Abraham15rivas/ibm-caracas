...
<body>
<font id="titulo">Registro de Instituto</font>
<br/>
<br/>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
  ...
  <tr>
    ...
    <td width="70%"></select><input name="cod"  id="cod" type="text" value="" size="12" maxlength="12"></td>
  </tr>
  <tr>
    <td width="30%">RIF:</td>
    <td width="70%">
  ...
  <tr>
    ...
    <tr>
    <td>Director:</td>
    <td><input name="director" id="director" type="text" size="20" maxlength="40"></td>
  </tr>
   <tr>
    <td>Cedula:</td>
...
if($_POST['cod']){
		...
		$registro=mysql_query($sql,$conexion);
			if($registro){
					echo "Instituto Registrada con Exito</br>";?> <script> alert("Instituto Registrado Con Exito");</script><?php 
		 					if($_POST['rif']){
