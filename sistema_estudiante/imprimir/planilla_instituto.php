...
<center>
<br />
<font id="imprimir_titulo">Planilla de Registro de Instituto</font>
...
error_reporting(0); 
	if($_POST['cod']){
		...
		$sql="select * from instituto where cod='$_POST[cod]'";
		$consulta=mysql_query($sql,$conexion);
					if(list($id_instituto,$cod,$letra_rif,$rif,$nombre_legal,$nombre_abreviado,$telefono,$celular,$correo,$pagina_web,$estado,$ciudad,$direccion,$fecha_fundacion,$distrito,$pastor,$celular_pastor,$estatus,$observaciones)=mysql_fetch_array($consulta))	
					{ ?>
...
<table width="700" border="1" cellspacing="2" cellpadding="0">
  ...
  <tr>
	<td><font id="imprimir_texto">Sub-Director:</font></td>
    <td></td>
  	<td><font id="imprimir_texto">Teléfono:</font></td>
    <td></td>
  </tr>
