...
<table width="600"  height="500" border="0" cellspacing="5" cellpadding="0">
  ...
  <tr>
    ...
    <p>
    Quien Suscribe; Director de esta Institución:  Rev. <strong>EDIS FLORES</strong>, C. I. <strong>5.266.685</strong> hace constar por medio de la presente que el ciudadano(a): <strong><?php echo strtoupper($nombre_1) ?> <?php echo strtoupper($nombre_2) ?> <?php echo strtoupper($apellido_1)?> <?php echo strtoupper($apellido_2)?></strong> Titular de la Cedula de Identidad: <strong><?php echo $cedula ?>, </strong> es alumno del <strong><?php echo $nivel ?> Nivel De Estudios <?php echo $curso?>, </strong> en un horario de 06:45PM a 09:00PM modalidas <?php echo $modalidad ?>.  </p>
      <br />
      <br />
      <br />
