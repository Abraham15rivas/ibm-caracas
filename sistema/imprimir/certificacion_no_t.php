...
<body>
<center>
<font id="imprimir_titulo">CERTIFICACIÓN DE NOTAS</font>
<hr width="800" />
...
<table width="800"  border="0" cellspacing="0" cellpadding="0">
      ...
      Quien Suscribe, Rev. <strong><?php echo($director)?></strong>, Titular de la cédula de identidad N° <strong><?php echo($cedula_d)?>,</strong> Director(a) del <?php echo($nombre_legal)?> y domicilio principal en la Ciudad de <?php echo($ciudad)?>, <?php echo($estado)?>. Certifica:<br />
            ...
            1° Que en el <?php echo($nombre_legal)?> reposa el expediente de estudios del ciudadano(a) <strong><?php echo strtoupper($nombre_1) ?> <?php echo strtoupper($nombre_2) ?> <?php echo strtoupper($apellido_1)?> <?php echo strtoupper($apellido_2)?></strong> Titular de la Cédula de Identidad: <strong><?php echo $l_cedula ?>-<?php echo $cedula ?></strong> egresó con fecha: <?php echo strftime("%#d de %B del %Y", strtotime($fecha_egreso ))?> con <strong><em>ESTUDIOS SUPERIORES DE TEOLOGIA</em></strong><br />            
            2° Que en su expediente se encuentra un registro academico donde consta que curso y aprobo todas las asignaturas que se especifica a continiación: 
...
<table width="800" border="1" cellspacing="0" cellpadding="0">
  <tr  bgcolor="#CCCCCC" scope="col" align="center">
  	<td width="40"><font size="2">Nivel</font></td>
    <td width="350"><font size="2">Nombres de la Asignaturas:</font></td>
    <td width="40"><font size="2">Notas</font></td>
    <td width="60"><font size="2">Porcentaje</font></td>
    <td width="60"><font size="2">UC.</font></td>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    3° Que la escala de calificación es del 1 al 20, y su mínima aprobatoria es de 14 Puntos y en porcentaje del 1 al 100 y la aprobacion de 70 Porciento<br />
    4° Total de Unidad de créditos aprobadas <?php echo $suct;?><br />
    5° La media ponderada de sus calificaciones fue: <?php echo $snotat=($snotab+$snotam+$snotal+$snotapv)/($nb+$nm+$nl+$npv) ?> y en porcentaje es <?php echo $snotat=(($snotat*100)/20)?>%<br />
    Esta Certificación de notas se expide  a solicitud de la parte interesada en la cuiudad de  <?php echo($ciudad)?>, <?php echo($estado)?>,  a los <?php include("../Funciones/fecha.php")?>. 
    </td>
  </tr>
  <tr>
    <td align="justify">
    <br /><br />
    <font id="imprimir_pequeno">Estudiante: <strong> <?php echo strtoupper($apellido_1)?> <?php echo strtoupper($nombre_1) ?></strong> </font><br />
    </td>
  </tr>
</table>
