...
<table width="700" border="0" cellspacing="2" cellpadding="0">
  <tr>
    ...
    <td width="200" align="right" rowspan="9">
      ...
      <form id="form8" name="form8" method="post" action="a_estudiante_buscar_actualizar.php">
        <input name="cedula" id="cedula" type="hidden" value="<?php echo $cedula ?>" />
        <input type="submit" name="actualizar" id="actualizar" value="Actualizar" />
      </form> 
      
      <form id="form9" name="form9" method="post" action="carnet/carnet_1.php">
        <input name="cedula" id="cedula" type="hidden" value="<?php echo $cedula ?>" />
        <input type="submit" name="Carnet" id="Carnet" value="Carnet" />
      </form>
