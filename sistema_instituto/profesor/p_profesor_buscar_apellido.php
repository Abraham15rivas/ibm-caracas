...
<body>
<font id="titulo">Buscar Profesor Por Apellido</font>
<br/>
<br/>
...
if($_POST['apellido']){
	...
	$sql="select * from profesor where apellido_1='$_POST[apellido]'";
...
<?php
    while(list($id_ministros,$cedula,$nombre_1,$nombre_2,$apellido_1,$apellido_2,$fecha_de_nacimiento,$edad,$pais_de_nacimiento,$estado_de_nacimiento,$estado_civil,$pareja,$telefono,$celular,$correo,$estado,$ciudad,$direccion,$instituto,$grado_ministerial,$ministerio,$estatus,$nivel_academico,$zona,$iglesia,$pastor,$notas)=mysql_fetch_array($consulta))	
	{
?>
